...
> **اینڈرائیڈ (Android):** ہرمیس اب اینڈرائیڈ اور ٹرمکس کو سپورٹ نہیں کرتا۔ سپورٹ شدہ پلیٹ فارمز کے لیے [پلیٹ فارم سپورٹ صفحہ](https://hermes-agent.nousresearch.com/docs/getting-started/platform-support) دیکھیں۔
>
